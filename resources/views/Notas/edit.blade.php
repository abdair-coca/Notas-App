...
<div class="max-w-3xl mx-auto">
    ...
    <header class="flex flex-col items-center text-center gap-2 mb-8">
        ...
        <span class="mt-1 inline-flex items-center gap-1 px-3 py-0.5 font-display font-bold text-[11px] uppercase tracking-wide border-2 border-[#1C1C1C] rounded-full bg-[#FEF9C3]">
            Editando: {{ \Illuminate\Support\Str::limit($nota->titulo, 32) }}
        </span>
    </header>
    ...
    <form action="{{ route('notas.update', $nota) }}" method="POST"
        ...
        <div class="absolute top-0 left-6 right-6 h-1.5 rounded-full bg-[#3B82F6] opacity-60 -translate-y-1/2"></div>
