...
<div class="max-w-3xl mx-auto py-6">
    ...
    <div class="bg-brand-orange border-[3px] border-brand-dark rounded-[20px] p-6 mb-6 flex items-center justify-between shadow-neo relative overflow-hidden">
        ...
        <div>
            <h1 class="font-fredoka text-3xl text-white [text-shadow:2px_2px_0_rgba(0,0,0,0.15)]">📚 Editar Nota</h1>
            <p class="font-bold text-sm text-white/90 mt-1">Edita una nota existente</p>
        </div>
